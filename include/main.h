...
const unsigned int size_gauss   = 3;
const unsigned int size_sharp   = 3;
const unsigned int size_unsharp = 5;
const unsigned int size_outline = 3;
const unsigned int size_emboss  = 3;
const unsigned int size_topSob  = 3;
const unsigned int size_btmSob  = 3;
const unsigned int size_rtSob   = 3;
const unsigned int size_ltSob   = 3;
